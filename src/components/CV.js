                                        ...
                                        <div class="col-md-12">
                                            <div id="cv" class="instaFade">
                                                <div class="mainDetails">
                                                    ...
                                                    <div id="name">
                                                        <h1 class="quickFade delayTwo">Ifat Ori</h1>
                                                    ...
                                                    <section>
                                                        ...
                                                        <div class="sectionContent">
                                                            <article>
                                                                ...
                                                                <p class="subDetails">July 2016 - August 2018</p>
                                                        ...
                                                        <div class="sectionContent">
                                                            <ul class="keySkills">
                                                                <li>
                                                                    <article>
                                                                        <h2>Hebrew</h2>
                                                                        <p class="subDetails">Mother Tongue</p>
                                                                    </article>
                                                                </li>
                                                                <li>
                                                                    <article>
                                                                        <h2>English</h2>
                                                                        <p class="subDetails">Excellent level</p>
                                                                    </article>
                                                                </li>
                                                            </ul>
                                                        </div>
